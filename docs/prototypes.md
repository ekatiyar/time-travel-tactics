...
- Weapons, erasure and restoration fronts, moving holes, winning, and cycles. See [Death and fronts](time-travel-tactics-design-doc.md#death-and-fronts), [Death as a moving hole](time-travel-tactics-design-doc.md#death-as-a-moving-hole), [Winning](time-travel-tactics-design-doc.md#winning), and [Cycles](time-travel-tactics-design-doc.md#cycles).
- Front and cycle UI, including index-gap readouts and countdowns. See [UI requirements](time-travel-tactics-design-doc.md#ui-requirements).
